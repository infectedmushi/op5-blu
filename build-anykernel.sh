...
KERNEL_ZIP="BM-$VARIANT-$(date +%y%m%d)-$HASH" 
...
# Paths
KERNEL_DIR="/mnt/Building/blu_spark-mod"
KBUILD_OUTPUT="${KERNEL_DIR}/../out"
REPACK_DIR="/mnt/Building/AnyKernel2-blu_spark"
PATCH_DIR="/mnt/Building/AnyKernel2-blu_spark/patch"
MODULES_DIR="/mnt/Building/AnyKernel2-blu_spark/modules/system/lib/modules"
...
case "$choice" in
    ...
    "gcc-linaro-7.3.1-2018.05-x86_64_aarch64-linux-gnu")
        export CROSS_COMPILE=/mnt/Linux/toolchains/aarch64-linux-gnu-7.3.1-linaro/bin/aarch64-linux-gnu-
        break;;
    "gcc-arm-8.2-2018.08-x86_64-aarch64-linux-gnu")
        export CROSS_COMPILE=/mnt/Linux/toolchains/gcc-arm-8.2-2018.08-x86_64-aarch64-linux-gnu/bin/aarch64-linux-gnu-
        break;;
